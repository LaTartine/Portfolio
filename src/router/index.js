...
const routes = [
  { path: '/', name: 'Accueil', component: Accueil, meta: {
      title: 'Allan Pinot - Portfolio',
      metaTags: [
        {
          name: 'Allan Pinot - Portfolio',
  ...
  {
    path: '/projet', name: 'Projet', component: Projet, meta: {
        title: 'Allan Pinot - Projet',
        metaTags: [
            {
                name: 'Allan Pinot - Projet',
                content: 'Allan Pinot Portfolio, illustration, sites webs, jeux et dessins. De nombreux projets dans une site animé. Posez vos questions ou contactez Allan Pinot.'
            },
            {
                property: 'og:description',
